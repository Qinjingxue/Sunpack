...
# The 7-Zip backend is compiled into sunpack_sevenzip_worker.exe. A leftover
# standalone 7z.dll would silently re-introduce the external backend dependency.
