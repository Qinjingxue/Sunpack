...
function Build-SevenZipWrapper {
    ...
    # explicit OFF switch for same-commit A/B benchmarking and rollback. Shared input is also
    # pinned ON for product builds; benchmark the old memcpy path in a separate CMake directory
    # with -DSUP7Z_USE_SHARED_INPUT=OFF.
