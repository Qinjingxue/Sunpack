...
from sunpack.core.support.resources import get_sevenzip_bridge_worker_path, program_data_dir
...
def _startup_registration() -> tuple[bool, str, str]:
    from sunpack.runtime.watch.startup import startup_command, startup_status
...
def _toast_check(config: dict | None, config_valid: bool) -> dict:
    ...
    try:
        from sunpack.core.platform.windows.toast_host import self_test_toast
