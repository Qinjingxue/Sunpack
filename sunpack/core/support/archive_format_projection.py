...
from sunpack.core.support.runtime_route_evidence import normalize_runtime_route_evidence
from sunpack.core.support.archive_knowledge_writer import commit_task_knowledge, ensure_knowledge, prepare_knowledge_value, write_flags, write_payload, write_prepared_payload
...
def _write_format_evidence(knowledge: Any, evidence: ArchiveFormatEvidence) -> None:
    ...
    route_payload = normalize_runtime_route_evidence({
        ...
        "source_derivation": {
            "zip_structure_features": _format_structure_payload(evidence.format, details),
...
def _format_structure_payload(fmt: str, details: dict[str, Any]) -> dict[str, Any]:
    ...
    return _dedup_zip_structure(structure)
