...
def _run_job(
    ...
    *,
    ...
    return {
        ...
        "input_planned_cursor_peak": int(input_trace.get("planned_cursor_peak", 0) or 0),
        "input_planned_cache_eviction_count": int(input_trace.get("planned_cache_eviction_count", 0) or 0),
        "input_planned_demand_issued_count": int(input_trace.get("planned_demand_issued_count", 0) or 0),
        "input_planned_hint_count": int(input_trace.get("planned_hint_count", 0) or 0),
        "input_planned_hint_bytes": int(input_trace.get("planned_hint_bytes", 0) or 0),
        "input_planned_hint_failure_count": int(input_trace.get("planned_hint_failure_count", 0) or 0),
