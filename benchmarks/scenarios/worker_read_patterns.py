...
def _pattern_table(rows: list[dict[str, Any]]) -> str:
    ...
    for row in rows:
        ...
        lines.append("| " + " | ".join((
            ...
            str(int(row.get("input_planned_hint_count") or 0)),
            _mib(row.get("input_planned_hint_bytes")),
            str(int(row.get("input_planned_hint_failure_count") or 0)),
...
def _write_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    columns = [
        ...
        "input_planned_cursor_peak", "input_planned_cache_eviction_count", "input_planned_demand_issued_count",
        "input_planned_hint_count", "input_planned_hint_bytes", "input_planned_hint_failure_count",
        ...
        "input_prefetch_published_count", "input_prefetch_orphaned_count",
